...
def get_usuario_rol(db: Session, usuario_id: int, rol_id: int):
    return (
        db.query(models.usuarios_roles.Usuario_Rol).filter(models.usuarios_roles.Usuario_Rol.Usuario_ID == usuario_id, models.usuarios_roles.Usuario_Rol.Rol_ID == rol_id).first()
    )
...
def update_usuario_rol(db: Session, usuario_id: int, rol_id: int, rol: schemas.usuarios_roles.Usuario_RolUpdate):
    db_user = db.query(models.usuarios_roles.Usuario_Rol).filter(models.usuarios_roles.Usuario_Rol.Usuario_ID == usuario_id, models.usuarios_roles.Usuario_Rol.Rol_ID == rol_id).first()
    if db_user:
